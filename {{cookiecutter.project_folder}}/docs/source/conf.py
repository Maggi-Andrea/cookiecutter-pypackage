...
#
{% if cookiecutter.docs_html_theme == 'Read The Docs' -%}
...
latex_documents = [
    ('index',
     '%s-%s.tex' % (project.replace(' ', '_'), release.replace('.', '-')),
      'Project %s Documentation' % (project),
      author,
     'manual'),
]
...
rst_epilog = """
.. |{{ cookiecutter.project_slug }}| replace:: **{project}**
""".format(
  project = project,
)
